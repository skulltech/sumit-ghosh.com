...
Now that we have an understanding of how QCOW works, let’s create a disk image for our VM.
...
- I’m creating an user with the username “sumit” using `name: sumit`, you name the user whatever you want.
